...
const boxingSessionSchema = new mongoose.Schema({
  name: {
    type: String,
...
boxingSessionSchema.index({ date: 1, startTime: 1 });

const BoxingSession = mongoose.model("boxingSessions", boxingSessionSchema);

export default BoxingSession;